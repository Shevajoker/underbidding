...
/**
 * Servlet implementation class MargomebelMskRuServlet
 */
public class MargomebelMskRuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MargomebelMskRuServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = (String) request.getParameter("margomebelMskRuUrl");
		
		MargomebelMskRu margomebelMskRu = new MargomebelMskRu();
		margomebelMskRu.saveProduct(url, article);
