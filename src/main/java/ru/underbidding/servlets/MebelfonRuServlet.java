...
/**
 * Servlet implementation class MebelfonRuServlet
 */
public class MebelfonRuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MebelfonRuServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = (String) request.getParameter("mebelfonRuUrl");
		
		MebelfonRu mebelfonRu = new MebelfonRu();
		mebelfonRu.saveProduct(url, article);
