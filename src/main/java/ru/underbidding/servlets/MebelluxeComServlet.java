...
/**
 * Servlet implementation class MebelluxeComServlet
 */
public class MebelluxeComServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MebelluxeComServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = (String) request.getParameter("mebelluxeComUrl");
		
		MebelluxeCom mebelluxeCom = new MebelluxeCom();
		mebelluxeCom.saveProduct(url, article);
