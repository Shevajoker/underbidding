...
import ru.underbidding.main.PlanetaKomfortaCom;
import ru.underbidding.model.AnrexProduct;
import ru.underbidding.service.AnrexProductService;

/**
 * Servlet implementation class PlanetaKomfortaComServlet
 */
public class PlanetaKomfortaComServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlanetaKomfortaComServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = (String) request.getParameter("planetaKomfortaComUrl");
		
		PlanetaKomfortaCom planetaKomfortaCom = new PlanetaKomfortaCom();
		planetaKomfortaCom.saveProduct(url, article);
