...
/**
 * Servlet implementation class MebellinerRuServlet
 */
public class MebellinerRuServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MebellinerRuServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = (String) request.getParameter("mebellinerRuUrl");
		
		MebellinerRu mebellinerRu = new MebellinerRu();
		mebellinerRu.saveProduct(url, article);
